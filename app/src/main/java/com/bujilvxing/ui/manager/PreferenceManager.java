...
public class PreferenceManager {
    ...
    public void clear() {
        ...
        setPrefLong(SPKey.User.USERID, 0);
        setPrefString(SPKey.User.NICKNAME, "");
        setPrefString(SPKey.User.AVATAR, "");
        setPrefInt(SPKey.User.GENDER, 0);
        setPrefString(SPKey.User.REGSIDENCE, "");
        setPrefString(SPKey.User.PLATFORM, "");
        setPrefString(SPKey.User.TOKEN, "");
        setPrefString(SPKey.User.RANDOMPWD, "");
        setPrefString(SPKey.User.birthday, "");
        setPrefString(SPKey.User.sign, "");
    }
}
